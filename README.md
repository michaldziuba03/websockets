...
According to official RFC and Wikipedia, `Sec-WebSocket-Accept` value is SHA-1 hash of `Sec-WebSocket-Key` combined with fixed UUID `258EAFA5-E914-47DA-95CA-C5AB0DC85B1`.
